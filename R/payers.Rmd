...
# get data
simple_21 <- read_csv("../data/561118388_uncmedicalcenter_cdmstandardcharges.csv",
                    #clean column names
                    name_repair = make_clean_names)

simple_22 <- read_csv("../data/561118388_uncmedicalcenter_standardcharges_22.csv",,
                    #clean column names
                    name_repair = make_clean_names)

# convert to numeric
# unmoney_df <- function(x){
#   x <- as.character()
# }
# 
# unmoney_df("d")
